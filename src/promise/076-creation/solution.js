...
describe('a promise can be created in multiple ways', function() {
  ...
  // it doesn't work, see --> https://github.com/tddbin/katas/issues/35
  describe('extending a `Promise`', function() {
    ...
    xit('must call `super()` in the constructor if it wants to inherit/specialize the behavior', function() {
